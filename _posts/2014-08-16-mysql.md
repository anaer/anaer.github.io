...
### 错误处理  
  ...
  A: ERROR 2003 (HY000): Can't connect to MySQL server on 'localhost' (0)

---
## Windows7下安装Mysql  

  参考网址:  
  http://blog.csdn.net/a672489861/article/details/11669697
...
## 存储过程  
  ...
  8. 存储过程例子
    ...
    ```sql
    DROP PROCEDURE IF EXISTS nta.f_run_sn_get;

    CREATE PROCEDURE f_run_sn_get (IN p_init_date DECIMAL(12), IN p_counter_no DECIMAL(12), OUT p_serial_no TEXT(65535), OUT p_serial_number DECIMAL(12), OUT p_error_no DECIMAL(12), OUT p_error_info TEXT(65535), OUT p_error_id DECIMAL(12), OUT p_error_sysinfo TEXT(65535))
    BEGIN
    ...
    set @e= 0;
    set @f=' ';
    call f_run_sn_get(20140101, 4, @a,@b,@c,@d,@e,@f);
    select @a,@b,@c,@d,@e,@f;
    ```
